...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_14336 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_14336(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_14337 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_14337(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_14338 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_14338(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_14339 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_14339(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_14340 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_14340(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_14341 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_14341(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_14342 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_14342(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_14343 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_14343(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_14344 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_14344(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_14345 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_14345(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_14346 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_14346(b);
}
});

...
var temp__5823__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
...
var reader = (function (){var or__4126__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4126__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return (128);
...
var map__17596 = top_item;
var map__17596__$1 = (((((!((map__17596 == null))))?(((((map__17596.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__17596.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__17596):map__17596);
var file = cljs.core.get.call(null,map__17596__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__17596__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__17596__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e17595){var _e = e17595;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5823__auto___17598 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5823__auto___17598)){
var seen_errors_17599 = temp__5823__auto___17598;
if(cljs.core.truth_(seen_errors_17599.has(self))){
} else {
seen_errors_17599.add(self);

var temp__5825__auto___17600 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5825__auto___17600)){
var sense_17601 = temp__5825__auto___17600;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_17601)].join(''));
} else {
}
}
} else {
...
var temp__5825__auto__ = devtools.hints.error_object_sense.call(null,error);
if(cljs.core.truth_(temp__5825__auto__)){
var sense = temp__5825__auto__;

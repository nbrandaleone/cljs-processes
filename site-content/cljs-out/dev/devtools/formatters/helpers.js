...
var G__15008 = devtools.prefs.pref.call(null,v);
v = G__15008;
continue;
} else {
return v;
...
if(cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)))){
if((!(cljs.core.var_QMARK_.call(null,value)))){
...
var or__4126__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e15011){var _e__14239__auto__ = e15011;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var or__4126__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e15015){var _e__14239__auto__ = e15015;
return false;
}})();
...
}catch (e15017){var _e__14239__auto__ = e15017;
return false;
}}
}
});
...
if((!(devtools.formatters.helpers.is_prototype_QMARK_.call(null,f)))){
...
var or__4126__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var and__4115__auto__ = (function (){var or__4126__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var vec__15019 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15019,(0),null);
var name = cljs.core.nth.call(null,vec__15019,(1),null);
...
var and__4115__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__4115__auto__)){
...
return cljs.core.some.call(null,(function (p1__15022_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15022_SHARP_);
}),template);
});
...
var temp__5823__auto__ = devtools.formatters.helpers.pref.call(null,pref_key);
if(cljs.core.truth_(temp__5823__auto__)){
var render_pref = temp__5823__auto__;
if(render_pref === true){

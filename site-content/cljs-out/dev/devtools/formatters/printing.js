...
var len__4736__auto___15051 = arguments.length;
var i__4737__auto___15052 = (0);
while(true){
if((i__4737__auto___15052 < len__4736__auto___15051)){
args__4742__auto__.push((arguments[i__4737__auto___15052]));

var G__15053 = (i__4737__auto___15052 + (1));
i__4737__auto___15052 = G__15053;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15048){
var G__15049 = cljs.core.first.call(null,seq15048);
var seq15048__$1 = cljs.core.next.call(null,seq15048);
var G__15050 = cljs.core.first.call(null,seq15048__$1);
var seq15048__$2 = cljs.core.next.call(null,seq15048__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15049,G__15050,seq15048__$2);
}));
...
if(cljs.core.truth_((function (){var or__4126__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
if(or__4126__auto__){
...
return cljs.core._write.call(null,writer__4370__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
var temp__5823__auto__ = cljs.core.first.call(null,cljs.core.first.call(null,group));
...
if(cljs.core.truth_(((cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group)))?(function (){var or__4126__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15054_SHARP_){
return (!((cljs.core.meta.call(null,p1__15054_SHARP_) == null)));
})))){
...
if(cljs.core.truth_((function (){var and__4115__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"render-path-annotations","render-path-annotations",-1890931512));
...
var map__15055 = opts;
var map__15055__$1 = (((((!((map__15055 == null))))?(((((map__15055.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15055.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15055):map__15055);
var markup_db = cljs.core.get.call(null,map__15055__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15059){var _e__14239__auto__ = e15059;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e15061){var _e__14239__auto__ = e15061;
return false;
}}
})())){
...
var temp__5823__auto__ = devtools.formatters.printing.build_markup.call(null,markup_db,new cljs.core.Keyword(null,"atomic","atomic",-120459460),obj);
if(cljs.core.truth_(temp__5823__auto__)){
var atomic_markup = temp__5823__auto__;
...
var _STAR_current_state_STAR__orig_val__15063 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15064 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15064);
...
var map__15065 = opts;
var map__15065__$1 = (((((!((map__15065 == null))))?(((((map__15065.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15065.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15065):map__15065);
var markup_db = cljs.core.get.call(null,map__15065__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15063);
}});
...
var temp__5823__auto___15070 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5823__auto___15070)){
var managed_print_level_15071 = temp__5823__auto___15070;
var _STAR_print_level_STAR__orig_val__15068_15072 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__15069_15073 = managed_print_level_15071;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__15069_15073);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__15067_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__15067_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__15068_15072);
}} else {
job_fn.call(null);
}
